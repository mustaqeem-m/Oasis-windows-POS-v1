...
class SellDatabase {
  ...
  Future<List<Map<String, dynamic>>> getSellLinesByStatus(
    ...
    var response = await db.rawQuery(
        'SELECT SL.*, V.display_name as product_name, V.product_image_url FROM sell_lines AS SL JOIN variations AS V ON SL.variation_id = V.variation_id WHERE SL.is_completed = ?',
        [isCompleted]);
    return response;
  }
