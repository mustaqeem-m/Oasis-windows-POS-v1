...
class SellReturnPopup extends StatefulWidget {
  const SellReturnPopup({super.key});

  @override
  _SellReturnPopupState createState() => _SellReturnPopupState();
}

class _SellReturnPopupState extends State<SellReturnPopup> {
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Container(
          ...
          child: Tooltip(
            message: 'Sell Return',
            child: Icon(Icons.undo_outlined, color: Colors.black, size: 20),
          ),
        ),
      ),
    );
